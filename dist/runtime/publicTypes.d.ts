...
export type SimpleTypes = StringType | NumberType | BooleanType | NullType | UndefinedType | ESSymbolType | VoidType | NeverType | AnyType | FalseLiteralType | TrueLiteralType | UnknownType | Unknown2Type;
export type ReflectedType = ObjectType | TupleType | ClassType | ReferenceType | UnionType | StringLiteralType | FunctionType | NumberLiteralType | SimpleTypes;
...
export interface StringLiteralType extends BaseType<TypeKind.StringLiteral, string> {
    value: string;
}
export interface NumberLiteralType extends BaseType<TypeKind.NumberLiteral, number> {
    value: number;
}
